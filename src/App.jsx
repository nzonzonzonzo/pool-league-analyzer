            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {availableAwayPlayers.map((player) => {
                ...
                const simulateMatchup = () => {
                  ...
                  // Store the opponent player selection in local variables instead of immediately updating state
                  ...
                  // Now run the simulation to find the best player
                  setTimeout(() => {
                    ...
                    for (const homePlayer of availableHomePlayers) {
                      ...
                      for (let i = 0; i < simCount; i++) {
                        ...
                        tempSelections.game1 = { home: homePlayer, away: selectedOpponent };
                    ...
                    setIsCalculating(false);
                  }, 100); // Longer timeout for Monte Carlo simulation
                };
                  ...
                  setTimeout(() => {
                    ...
                    for (const homePlayer of availableHomePlayers) {
                      ...
                      for (let i = 0; i < simCount; i++) {
                        // Create temporary game selections
                        const tempSelections = cloneSelections(selectedPlayers);
                        tempSelections.game2 = { home: homePlayer, away: selectedOpponent };
                  ...
                  setTimeout(() => {
                    ...
                    for (const homePlayer of availableHomePlayers) {
                      ...
                      for (let i = 0; i < simCount; i++) {
                        // Create temporary game selections
                        const tempSelections = cloneSelections(selectedPlayers);
                        tempSelections.game3 = { home: homePlayer, away: selectedOpponent };
